...
b11 = Book.create(title: "A Game of Thrones", author: "George Martin", description: "A tale of politics and deceit as families fight to put one of their own on the Iron throne as King of Westeros, who will win ths Game of Thrones", publisher: "Voyager Books", weeks_on_list: 55, rank_this_week: 11)
...
Review.create(comment: "One of the best books I have ever read, Martin has created a wonderful world full of interesting characters. You never know what will happen next", author: "Eoin Breen", book_id: b11.id)
